// src/pages/downline-transaction/components/downline-transaction-table-top-content.tsx

import React from "react";
import { RangeValue } from "@react-types/shared";
import { formatCurrency, formatDateRange } from "@/utils/formatters";
import { STATUS_OPTIONS } from "../constants/downline-transactions-contants";
import {
  Dropdown,
  DropdownTrigger,
  DropdownMenu,
...
interface DownlineTransactionTableTopContentProps {
  ...
  onFilterChange: (field: keyof DownlineTransactionFilters, value: any) => void;
  onSearchSubmit: () => void;
  onResetFilters: () => void;
  totalItems: number;
  summary: {
