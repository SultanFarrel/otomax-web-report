...
import { ProductFilters } from "@/hooks/useAdminProducts";
...
export const AdminProductTableTopContent: React.FC<
  ProductTableTopContentProps
> = ({
  filters,
  onFilterChange,
  onSearchSubmit,
